        ...
        <Dropdown>
          <DropdownTrigger>
            <Button className={cn("ml-auto", className)}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" class="h-5 w-5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"></path></svg>
            </Button>
          </DropdownTrigger>
          <DropdownMenu aria-label="Static Actions">
            ...
            <DropdownItem key="edit"><header.UserNav /></DropdownItem>
          </DropdownMenu>
        </Dropdown>
      </>
